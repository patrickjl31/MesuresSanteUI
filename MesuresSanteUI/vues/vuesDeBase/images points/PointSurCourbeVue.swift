//
//  PointSurCourbeVue.swift
//  MesuresSanteUI
//
//  Created by patrick lanneau on 17/03/2022.
//

import SwiftUI

struct PointSurCourbeVue: View {
    var symbole: String
    var centre:CGPoint
...
struct PointSurCourbeVue_Previews: PreviewProvider {
    static var previews: some View {
        PointSurCourbeVue(symbole: "fork.knife.circle", centre: CGPoint(x: 150.0, y: 50.0), diametre: 50, legende: "rien")
    }
}
