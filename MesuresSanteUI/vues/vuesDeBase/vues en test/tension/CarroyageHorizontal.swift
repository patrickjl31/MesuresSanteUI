    ...
    */
    var body: some View {
        ...
        GeometryReader{geometry in
            ...
            let ecartValeurs = limHR - limBR
            let entreLignes = ecartValeurs / 10.0
            ...
            ForEach((1...10).reversed(), id: \.self) { index in
                ...
                let legende = (String(format: precision(ecart: ecartValeurs), limB +  entreLignes * CGFloat( index - 1)))
...
struct CarroyageHorizontal_Previews: PreviewProvider {
    static var previews: some View {
        CarroyageHorizontal(limB: 0.33, limH: 1.77)
